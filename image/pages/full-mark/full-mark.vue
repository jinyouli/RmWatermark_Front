				...
				<swiper-item class="u-flex-col u-row-center">
					<view class="u-p-l-30 u-p-r-30">
						...
						<view class="u-flex">
							...
							<view class="u-flex-1">
								<slider :value="setting.maskOpcity" @change="sliderChange('maskOpcity',$event)" min="0"
									max="1" step="0.1" show-value block-size="18" activeColor="#303133" />
							</view>
						</view>
						<view class="u-text-center u-tips-color u-font-24 u-p-t-20">如无需蒙板，请将蒙板透明度设为0</view>
					</view>
				</swiper-item>
				<!-- end 蒙板 -->
			</swiper>
		...
		methods: {
			...
			async setCanvas() {
				...
				query.select("#canvasBox").fields({
					...
					if (setting.textColor.toLowerCase() == "#ffffff") {
						canvasCtx.shadowColor = '#a1a1a1'
